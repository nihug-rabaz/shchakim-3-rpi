  ...
  return (
    <div style={{
      ...
      <iframe
        ...
        style={{
          ...iframeStyle,
          opacity: currentView === 'slider' && allFramesLoaded ? 1 : 0,
          pointerEvents: currentView === 'slider' && allFramesLoaded ? 'auto' : 'none',
      ...
      <iframe
        ...
        style={{
          ...iframeStyle,
          opacity: currentView === 'letter' && allFramesLoaded ? 1 : 0,
          pointerEvents: currentView === 'letter' && allFramesLoaded ? 'auto' : 'none',
