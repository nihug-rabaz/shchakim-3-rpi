...
class ShchakimIntegration {
  ...
  // Register Polin font if available under /fonts
  ensurePolinFont() {
    if (document.getElementById('shchakim-fonts-style')) return;
    const style = document.createElement('style');
    style.id = 'shchakim-fonts-style';
    style.textContent = `
/* Try multiple common filenames; last fallback is an available font in /public/fonts */
@font-face { font-family: 'Polin'; src:
  url('/fonts/Polin/Polin-Regular.woff2') format('woff2'),
  url('/fonts/Polin/Polin-Regular.woff') format('woff'),
  url('/fonts/Polin/Polin-Regular.ttf') format('truetype'),
  url('/fonts/Polin-Regular.woff2') format('woff2'),
  url('/fonts/Polin-Regular.woff') format('woff'),
  url('/fonts/Polin-Regular.ttf') format('truetype'),
  url('/fonts/Polin/Polin.woff2') format('woff2'),
  url('/fonts/Polin/Polin.woff') format('woff'),
  url('/fonts/Polin/Polin.ttf') format('truetype'),
  url('/fonts/Polin.woff2') format('woff2'),
  url('/fonts/Polin.woff') format('woff'),
  url('/fonts/Polin.ttf') format('truetype'),
  url("/fonts/Open 24 Display St.ttf") format('truetype'); /* fallback present in repo */
  font-weight: 400; font-style: normal; font-display: swap; }
@font-face { font-family: 'Polin'; src:
  url('/fonts/Polin/Polin-Bold.woff2') format('woff2'),
  url('/fonts/Polin/Polin-Bold.woff') format('woff'),
  url('/fonts/Polin/Polin-Bold.ttf') format('truetype'),
  url('/fonts/Polin-Bold.woff2') format('woff2'),
  url('/fonts/Polin-Bold.woff') format('woff'),
  url('/fonts/Polin-Bold.ttf') format('truetype'),
  url('/fonts/Polin/Polin-Bold.otf') format('opentype'),
  url('/fonts/Polin-Bold.otf') format('opentype'),
  url("/fonts/Open 24 Display St.ttf") format('truetype'); /* fallback */
  font-weight: 700; font-style: normal; font-display: swap; }
body, #shchakim-slider, #shchakim-top-overlay { font-family: 'Polin', system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; }
`;
    document.head.appendChild(style);
    // Attempt to load the font early
