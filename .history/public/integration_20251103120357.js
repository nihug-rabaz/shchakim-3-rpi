...
class ShchakimIntegration {
  ...
  async ensurePolinFontAsync() {
    ...
    const regularCandidates = [
      '/fonts/Polin/Polin-Regular.woff2',
      '/fonts/Polin/Polin-Regular.woff',
      '/fonts/Polin/Polin-Regular.ttf',
      '/fonts/Polin-Regular.woff2',
      '/fonts/Polin-Regular.woff',
      '/fonts/Polin-Regular.ttf',
      '/fonts/Polin/Polin.woff2',
      '/fonts/Polin/Polin.woff',
      '/fonts/Polin/Polin.ttf',
      '/fonts/Polin.woff2',
      '/fonts/Polin.woff',
      '/fonts/Polin.ttf'
    ];
    const boldCandidates = [
      '/fonts/Polin/Polin-Bold.woff2',
      '/fonts/Polin/Polin-Bold.woff',
      '/fonts/Polin/Polin-Bold.ttf',
      '/fonts/Polin-Bold.woff2',
      '/fonts/Polin-Bold.woff',
      '/fonts/Polin-Bold.ttf',
      '/fonts/Polin/Polin-Bold.otf',
      '/fonts/Polin-Bold.otf'
    ];

    const regular = await probe(regularCandidates) || '/fonts/Open%2024%20Display%20St.ttf';
    const bold = await probe(boldCandidates) || regular;
