...
class ShchakimIntegration {
  ...
  setupSlider() {
    try {
      ...
      // Reference the original image (keep it visible; ensure slider won't cover it)
      ...
      // Force requested size 800x800 and background by theme
      target.style.width = '800px';
      target.style.height = '800px';
      target.style.background = this.themeColor;
      // Nudge container slightly (avoid overlapping nearby texts)
      ...
      const height = rect.height || target.clientHeight || 800;
      ...
      // Shift slider content slightly to the left, but avoid covering original image
