...
class ShchakimIntegration {
  ...
  setupSlider() {
    try {
      ...
      // Prepare container: insert slider OUTSIDE the rectangle as a sibling
      const parent = target.parentElement || document.querySelector('.frame-17') || document.body;
      ...
      // Position near the rectangle but not on top
