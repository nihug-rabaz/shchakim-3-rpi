...
class ShchakimIntegration {
  ...
  updateTheme(theme) {
    ...
    // Update background to blue→purple gradient
    ...
    if (mainFrame) {
      mainFrame.style.backgroundImage = gradient;
    ...
    if (slider) {
      ...
      slides.forEach((s) => { s.style.backgroundImage = gradient; s.style.backgroundColor = ''; });
      ...
      halachaCards.forEach((c) => {
        c.style.backgroundImage = 'linear-gradient(135deg, rgba(59,130,246,0.9) 0%, rgba(139,92,246,0.9) 100%)';
